...
// One deliberate deviation: the hub only ever shows its own "blonskyi.dev" brand mark, but
// todolist is a sub-app under it, so this needs a second breadcrumb segment ("Todolist") with a
// separator - the hub has no equivalent to mirror. Differentiated by color only (muted vs
// foreground), not weight, so both segments still share the hub's font-semibold treatment.
